...
export const generateAssessmentPDF = (
  ...
  doc.text("For a comprehensive security review, contact us at info@myriaconsulting.com", margin, pageHeight - 13);
  doc.text("More about Myria Consulting, visit our website at www.myriaconsulting.com", margin, pageHeight - 8);
